...
export const promptly: App = createApp({
  slug:     "promptly",
  name:     "Promptly",
  tagline:  "Structured AI education built for the real world.",
  headline: "Master modern AI — from first prompts to real workflows.",
  subheadline:
    "Promptly is an AI learning platform that teaches you how to actually use modern AI tools, build workflows, create apps, automate tasks, and think like an AI-native creator or entrepreneur.",
  summary:
  ...
  description:
    "Promptly is an AI learning app for iOS 16+ that teaches practical mastery of modern AI tools — ChatGPT, Claude, Gemini, and more — through short lessons, interactive challenges, XP and streaks, and project-based learning for productivity, business, coding, design, and content creation.",
  status:        "beta",
  platforms:     ["ios"],
  featured:      false,
  accent:        "#22d3ee",
  iconImage:     "/images/promptly-icon.png",
  category:      "Education",
  ...
  pageCopy: {
    howItWorks: {
      ...
      lead:
        "Promptly is built around fast lessons, practical projects, and constant progression.",
    },
    features: {
    ...
    mistakes: {
      heading: "Learning mistakes Promptly helps users avoid",
      lead:
        "Small habits can slow you down as AI tools evolve. Here is what Promptly is designed to help you fix early.",
    },
    tips: {
  ...
  whatItDoes:
    "Most people only use AI at surface level. Promptly is a guided path—short lessons, checkpoints, streaks, XP, and hands-on projects—that takes you from basics to real builds: picking the right models (e.g. ChatGPT, Claude, Gemini), prompting well, agents and automations, and applying AI across business, coding, design, productivity, and content. You level up by finishing challenges and projects—not by doom-scrolling tutorials.",
  ...
  screenshots: [
    {
      src: "",
      alt: "Promptly home screen concept — daily lessons, streaks, XP, and learning paths",
    ...
    {
      src: "",
      alt: "Promptly courses screen concept — structured lesson maps and checkpoints",
    ...
    {
      src: "",
      alt: "Promptly projects screen concept — hands-on builds and exercises",
    ...
    {
      src: "",
      alt: "Promptly AI companion concept — in-app mentor with feedback",
  ...
  mistakes: [
    {
      ...
      body:
        "Most users treat every AI tool the same. Promptly teaches when to use different models for writing, coding, research, reasoning, visuals, and automation.",
    },
    {
      heading: "Writing weak prompts",
      body:
        "Small prompt changes massively affect output quality. Promptly teaches structure, context framing, iteration, and workflow thinking.",
    },
    {
      heading: "Consuming without practicing",
      body:
        "Watching AI content is not the same as building. Promptly focuses heavily on projects, exercises, and repetition.",
    },
    {
      heading: "Trying advanced workflows too early",
      body:
        "Many beginners jump straight into agents and automation without understanding fundamentals. Promptly builds progression intentionally.",
    },
    {
      heading: "Falling behind as AI evolves",
      body:
        "AI changes fast. Promptly is designed as a living platform that continuously expands with new tools, workflows, and best practices.",
    },
  ],
  ...
  tips: [
    {
      ...
      body:
        "The fastest way to improve is creating real systems — not memorizing terminology. Promptly pushes users toward execution from day one.",
    },
    {
      heading: "Compare outputs between models",
      body:
        "Understanding why one model performs better than another is a major skill advantage. Promptly trains this directly.",
    },
    {
  ...
  ctaBody:
    "Promptly turns AI education into an interactive progression system — helping users move from confusion to real capability through lessons, projects, and hands-on practice.",

  seo: {
    title: "Promptly — Structured AI Learning for the Real World",
    description:
    ...
    ogImage: "/images/promptly-icon.png",
  },

  faq: [
    {
      q: "What is Promptly?",
      a: "Promptly is an AI learning platform for iOS that teaches you how to use modern AI tools in the real world — not just theory. You get structured paths, short lessons, hands-on challenges, projects, streaks, and XP so skills compound over time.",
    },
    {
      q: "Is Promptly beginner friendly?",
    ...
    },
    {
      ...
      a: "Promptly is built as a living platform: new lessons, tools, workflows, and best practices are added as the AI landscape evolves.",
    },
    {
      q: "Who is Promptly built for?",
